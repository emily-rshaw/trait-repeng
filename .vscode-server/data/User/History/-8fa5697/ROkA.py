...
if __name__ == "__main__":
    extract_ipip_traits("data/psychometric_tests/personality/ipip_neo_120_formatted.csv", "scripts/database_management/trait_structure_management/personality_traits.csv")
...
def get_available_traits(traits_dir="trait_specific"):
    ...
    try:
        ...
        return sorted(list(trait_groups.keys()))
...
def create_ui():
    ...
    # Default paths
    default_traits_dir = "../data/psychometric_tests/personality/trait_specific"
    default_output_dir = "../results"
    
    # Just use the hardcoded traits from the get_available_traits function
